...
<body class="index-page">
  ...
  <main class="container mt-5 pt-5">
    <div class="card">
      <div class="card-body">
        <h5 class="card-title text-right">DATA ANGGOTA</h5>
        <?php if(isset($_SESSION['status']) && $_SESSION['status'] == 'Admin'):?>
              ...
              ?>
                <tr>
                  ...
                  <td>
                    ...
                    <a href="edit_anggota.php?id_anggota=<?= $data['id_anggota']; ?>" class="btn btn-primary">
                     <i class="bi bi-pencil-square"></i> Edit
                    </a>
                        <a href="hapus_anggota.php?id_anggota=<?= isset($data['id_anggota']) ? $data['id_anggota'] : ''; ?>" 
