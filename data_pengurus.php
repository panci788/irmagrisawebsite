...
<body class="index-page">
  ...
  <main class="container mt-5 pt-5">
    <div class="card">
      <div class="card-body">
        <h5 class="card-title text-right">DATA KEPENGURUSAN</h5>
        <?php if(isset($_SESSION['status']) && $_SESSION['status'] == 'Admin'):?>
        <div class="text-end mb-3">
          <a href="tambah_kepengurusan.php" class="btn btn-primary">
            <i class="bi bi-plus-circle"></i> Tambah Kepengurusan
          </a>
        </div>
        <?php endif ?>
        <!-- Table -->
              ...
              ?>
                <tr>
                  ...
                  <td>
                    ...
                    <a href="edit_pengurus.php?id_pengurus=<?= $data['id_pengurus']; ?>" class="btn btn-primary">
                     <i class="bi bi-pencil-square"></i> Edit
                    </a>
                        <a href="hapus_pengurus.php?id_pengurus=<?= isset($data['id_pengurus']) ? $data['id_pengurus'] : ''; ?>" 
